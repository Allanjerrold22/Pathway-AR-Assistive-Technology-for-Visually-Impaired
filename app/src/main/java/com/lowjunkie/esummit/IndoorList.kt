...
import kotlinx.android.synthetic.main.indoor_list_screen.*
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import java.util.*

class IndoorList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.indoor_list_screen)
    ...
    private fun setupHomeRecyclerView(){
        ...
        homeRV.apply {
            adapter = homeAdapter
            layoutManager = LinearLayoutManager(this@IndoorList)
        }
    }
}